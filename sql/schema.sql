...
ALTER TABLE section ADD CONSTRAINT image_app_user FOREIGN KEY image_app_user (app_user_id)
REFERENCES app_user (id);

-- Reference: image_drawing (table: section)
ALTER TABLE section ADD CONSTRAINT image_drawing FOREIGN KEY image_drawing (drawing_id)
